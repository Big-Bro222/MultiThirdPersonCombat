...
namespace BigBro
{
	...
	{
		[HideInInspector]
		public KCCAnimancerFSM Controller;
		[HideInInspector]
	...
	{
		public PlayerBehaviourMachine(string name, KCCAnimancerFSM controller, AnimancerComponent animancer, params PlayerStateBehaviour[] states) : base(name, states)
		{
