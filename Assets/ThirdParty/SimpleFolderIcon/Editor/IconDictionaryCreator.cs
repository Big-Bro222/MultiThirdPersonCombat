...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = DictionaryParentConfig.ParentDir+"SimpleFolderIcon/Icons";
        ...
        private static bool ContainsIconAsset(string[] assets)
        {
            foreach (string str in assets)
            {
                ...
                {
                    IconPath = ReplaceSeparatorChar(Path.GetDirectoryName(str)).Replace("Assets/","");
                    return true;
                }
            }
            return false;
